...
import notificationsData from '../data/notifications.json';  // Assuming you have some notifications data

describe('Notification schema', () => {
  const normalizedData = normalize(notificationsData, [notification]);

  it('should verify that normalized data has correct result array', () => {
  ...
  it('should verify that normalized data has a correct user entity', () => {
  ...
  it('should verify that normalized data has a correct message entity', () => {
  ...
  it('should verify that normalized data has a correct notification entity', () => {
