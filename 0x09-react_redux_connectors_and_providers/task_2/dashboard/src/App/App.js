...
import { loginRequest } from '../actions/auth'; // Import the loginRequest action creator
...
class App extends React.Component {
  ...
  render() {
    const { login, isUserLoggedIn, loading, error } = this.props;

    // You can now use the `login` function from props to trigger the login action
    return (
      <div>
...
const mapStateToProps = (state) => ({
  isUserLoggedIn: state.uiReducer.get('isUserLoggedIn'),
  loading: state.uiReducer.get('loading'),
  error: state.uiReducer.get('error'),
});
